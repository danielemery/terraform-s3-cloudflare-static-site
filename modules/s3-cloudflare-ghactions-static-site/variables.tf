...
variable "environment" {
  type        = string
  description = <<EOT
    Optional environment, this determines the subdomain at which the site will be served, the github actions environment and a name suffix for each of the resources generated.
...
variable "github_repository" {
  type        = string
  description = "The github repository where deploy secrets should be added in the format 'owner/repo'"
}
